...
public class Menu {
    ...
    private void addDriver() {
        ...
        System.out.print("ID: ");
        String id = Utilitas.inputLine();
        System.out.print("Nama: ");
        String nama = Utilitas.inputLine();
        System.out.print("Telepon: ");
        String telepon = Utilitas.inputLine();
        System.out.print("Plat Nomor: ");
        String platNo = Utilitas.inputLine();
        System.out.print("Jenis Kendaraan: ");
        String jenisKendaraan = Utilitas.inputLine();
        System.out.print("Saldo Awal: ");
        double saldo = Utilitas.inputInt();
    ...
    private void topUpSaldo() {
        ...
        double amount = Utilitas.inputInt();
    ...
    private void doTransaction() {
        ...
        System.out.println("\n------o0 TRANSAKSI 0o------");
        System.out.print("\nMasukkan ID driver: ");
        String driverId = Utilitas.inputLine();
        System.out.print("Masukkan ID customer: ");
        String customerId = Utilitas.inputLine();
