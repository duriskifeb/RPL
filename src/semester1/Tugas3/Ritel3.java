...
class Ritel3{
    ...
    public void inputData(){
        try{
            ...
            System.out.println("==============================");
            System.out.println("MENU INPUT DATA Ritel");
            System.out.println("==============================");
    ...
    public void viewData(){
        System.out.println("==============================");
        System.out.println("MENAMPILKAN DETAIL Ritel");
        System.out.println("==============================");
    ...
    public void jualStock(int ubah){
        System.out.println("==============================");
        System.out.println("MENU PENJUALAN Ritel");
        System.out.println("==============================");
    ...
    public void tambahStock(int ubah){
        System.out.println("==============================");
        System.out.println("MENU PEMBELIAN Ritel");
        System.out.println("==============================");
...
class RitelMakan{
    public static void main(String[] args) {
        Ritel3 brg1 = new Ritel3();
        Ritel3 brg2 = new Ritel3();
